...
def process_lieferschein_image(image_bytes, anthropic_api_key):
    ...
    system_message = {
        ...
        Return the extracted data as a JSON object representing a table, where each key is a column name and its value is a list of entries for that column. Do not add any comments, do not use markdown code blocks or code fences, return only the raw JSON object and nothing else."""
    }
